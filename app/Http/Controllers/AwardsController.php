...
class AwardsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('awards.index')->with('message', 'Data berhasil ditambah');
    }
    ...
    public function edit(string $id)
    {
        ...
        $edit = Awards::find($id);
        $title = "Edit Data Penghargaan" . $edit->name_awards;
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->to('awards.index')->with('message', 'Penghargaan berhasil diubah');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->to('awards.index')->with('message', 'Data berhasil dihapus');
    }
}

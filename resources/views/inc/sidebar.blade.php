    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('skillbahasa.index') }}">Skills Bahasa</a>
                <a class="collapse-item" href="{{ route('skillsoftware.index') }}">Skills Software</a>
                <a class="collapse-item" href="{{ route('project.index') }}">Project</a>
                <a class="collapse-item" href="{{ route('awards.index') }}">Awards</a>
            </div>
        </div>
    </li>

                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                                <div class="text-uppercase">System Analyst &middot; Accounting &middot; Data Analyst
                                    &middot; HRGA</div>
                            </div>
                            <div class="fs-3 fw-light text-muted">{{ $profile->pembukaan }}</div>
                            <h1 class="display-3 fw-bolder mb-5"><span
                                    class="text-gradient d-inline">{{ $profile->motivasi }}</span></h1>
                            <div
                                ...
                                <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder"
                                    href="{{ asset('assets/personal/resume.blade.html') }}">Resume</a>
                                <a class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder"
                                    href="{{ asset('assets/personal/projects.blade.html') }}">Projects</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-7">
                        ...
                        <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div class="profile bg-gradient-primary-to-secondary">
                                ...
                                <img class="profile-img" src="{{ asset('assets/personal/assets/aku.png') }}"
                                    alt="..." />
                                <div class="dots-1">
                                    <!-- SVG Dots-->
                    ...
                    <div class="col-xxl-8">
                        <div class="text-center my-5">
                            ...
                            <p class="lead fw-light mb-4">
                                {{ $profile->fullname }} - {{ $profile->phone }} - {{ $profile->address }} - {{ $profile->email }}
                            </p>
                            <p class="text-muted">{{ $profile->description }}</p>
                            <div class="d-flex justify-content-center fs-2 gap-4">
                                <a class="text-gradient" href="{{ $profile->instagram_link }}"><i
                                        class="bi bi-instagram"></i></a>
                                <a class="text-gradient" href="{{ $profile->linkedin_link }}"><i
                                        class="bi bi-linkedin"></i></a>
                                <a class="text-gradient" href="{{ $profile->github_link }}"><i
                                        class="bi bi-github"></i></a>
                                <a class="text-gradient" href="{{ $profile->facebook_link }}"><i
                                        class="bi bi-facebook"></i></a>
                                <a class="text-gradient" href="{{ $profile->youtube_link }}"><i
                                        class="bi bi-youtube"></i></a>
                                <a class="text-gradient" href="{{ $profile->tiktok_link }}"><i

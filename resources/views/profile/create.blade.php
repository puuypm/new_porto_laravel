        ...
        <div class="card-body">
            <form action="{{ route('profile.store') }}" method="post">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="pembukaan" placeholder="Masukkan Deskripsi Pembukaan Anda"
                        class="form-control">
                </div>
                <div class="form-group mb-3">
                    <label for="">Motivasi</label>
                    <input type="text" name="motivasi" placeholder="Masukkan Deskripsi Motivasi Anda"
                        class="form-control">
                </div>
                <div class="form-group mb-3">

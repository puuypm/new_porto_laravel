    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('profile.update', $edit->id) }}" method="post">
                ...
                <div class="form-group mb-3">
                    <label for="">Pembukaan</label>
                    <input value="{{ $edit->pembukaan }}" type="text" name="pembukaan"
                        placeholder="Masukkan Deskripsi Pembukaan Anda" class="form-control">
                </div>
                <div class="form-group mb-3">
                    <label for="">Motivasi</label>
                    <input value="{{ $edit->motivasi }}" type="text" name="motivasi" placeholder="Masukkan Motivasi Anda"
                        class="form-control">
                </div>
                <div class="form-group mb-3">
